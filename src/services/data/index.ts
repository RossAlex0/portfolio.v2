...
export const projects: Project[] = [
  {
    ...
    year: "2025",
    techno: [
      { name: "CSS", icon: { type: "Fa", name: "FaCss3Alt" } },
      { name: "TypeScript", icon: { type: "Bi", name: "BiLogoTypescript" } },
      { name: "React", icon: { type: "Fa", name: "FaReact" } },
      { name: "Next", icon: { type: "Ri", name: "RiNextjsFill" } },
      { name: "Vercel", icon: { type: "Si", name: "SiVercel" } },
      { name: "Figma", icon: { type: "Fa", name: "FaFigma" } },
    ],
  ...
  },
  {
    ...
    techno: [
      ...
      {
        name: "React-Native",
        icon: { type: "Tb", name: "TbBrandReactNative" },
      },
      { name: "Expo", icon: { type: "Si", name: "SiExpo" } },
      { name: "NodeJs", icon: { type: "Fa", name: "FaNodeJs" } },
      { name: "ExpressJs", icon: { type: "Si", name: "SiExpress" } },
      { name: "MongoDB", icon: { type: "Si", name: "SiMongodb" } },
      { name: "Figma", icon: { type: "Fa", name: "FaFigma" } },
    ],
  ...
  },
  {
    ...
    techno: [
      { name: "CSS", icon: { type: "Fa", name: "FaCss3Alt" } },
      { name: "JavaScript", icon: { type: "Ri", name: "RiJavascriptFill" } },
      { name: "React", icon: { type: "Fa", name: "FaReact" } },
      { name: "NodeJs", icon: { type: "Fa", name: "FaNodeJs" } },
      { name: "ExpressJs", icon: { type: "Si", name: "SiExpress" } },
      { name: "MySQL", icon: { type: "Si", name: "SiMysql" } },
      { name: "Figma", icon: { type: "Fa", name: "FaFigma" } },
    ],
    github:
  ...
  },
  {
    ...
    techno: [
      ...
      { name: "Expo", icon: { type: "Si", name: "SiExpo" } },
      { name: "GraphQl", icon: { type: "Si", name: "SiGraphql" } },
      { name: "Sentry", icon: { type: "Si", name: "SiSentry" } },
      { name: "Apollo", icon: { type: "Si", name: "SiApollographql" } },
      { name: "Directus", icon: { type: "Si", name: "SiDirectus" } },
      { name: "NodeJs", icon: { type: "Fa", name: "FaNodeJs" } },
      { name: "ExpressJs", icon: { type: "Si", name: "SiExpress" } },
      { name: "PostgreSQL", icon: { type: "Si", name: "SiPostgresql" } },
      { name: "Docker", icon: { type: "Fa", name: "FaDocker" } },
      { name: "AWS", icon: { type: "Fa", name: "FaAws" } },
    ],
    github: null,
    link: null,
  ...
  },
  {
    ...
    techno: [
      ...
      { name: "TypeScript", icon: { type: "Bi", name: "BiLogoTypescript" } },
      { name: "React", icon: { type: "Fa", name: "FaReact" } },
      { name: "Vite", icon: { type: "Si", name: "SiVite" } },
      { name: "Vercel", icon: { type: "Si", name: "SiVercel" } },
      { name: "OVH", icon: { type: "Si", name: "SiOvh" } },
    ],
  ...
  },
  {
    ...
    techno: [
      ...
      { name: "NodeJs", icon: { type: "Fa", name: "FaNodeJs" } },
      { name: "ExpressJs", icon: { type: "Si", name: "SiExpress" } },
      { name: "GoogleService", icon: { type: "Si", name: "SiGmail" } },
      { name: "Vercel", icon: { type: "Si", name: "SiVercel" } },
    ],
  ...
  },
  {
    ...
    techno: [
      ...
      { name: "ExpressJs", icon: { type: "Si", name: "SiExpress" } },
      { name: "MySQL", icon: { type: "Si", name: "SiMysql" } },
      { name: "ViteJs", icon: { type: "Si", name: "SiVite" } },
      { name: "Figma", icon: { type: "Fa", name: "FaFigma" } },
    ],
